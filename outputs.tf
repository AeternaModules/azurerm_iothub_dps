output "iothub_dpses_id" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.id if v.id != null && length(v.id) > 0 }
}
output "iothub_dpses_allocation_policy" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.allocation_policy if v.allocation_policy != null && length(v.allocation_policy) > 0 }
}
output "iothub_dpses_data_residency_enabled" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.data_residency_enabled if v.data_residency_enabled != null }
}
output "iothub_dpses_device_provisioning_host_name" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.device_provisioning_host_name if v.device_provisioning_host_name != null && length(v.device_provisioning_host_name) > 0 }
}
output "iothub_dpses_id_scope" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.id_scope if v.id_scope != null && length(v.id_scope) > 0 }
}
output "iothub_dpses_ip_filter_rule" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.ip_filter_rule if v.ip_filter_rule != null && length(v.ip_filter_rule) > 0 }
}
output "iothub_dpses_linked_hub" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.linked_hub if v.linked_hub != null && length(v.linked_hub) > 0 }
  sensitive   = true
}
output "iothub_dpses_location" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.location if v.location != null && length(v.location) > 0 }
}
output "iothub_dpses_name" {
  description = "Map of name values across all iothub_dpses, keyed the same as var.iothub_dpses"
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.name if v.name != null && length(v.name) > 0 }
}
output "iothub_dpses_public_network_access_enabled" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.public_network_access_enabled if v.public_network_access_enabled != null }
}
output "iothub_dpses_resource_group_name" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "iothub_dpses_service_operations_host_name" {
  ...
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.service_operations_host_name if v.service_operations_host_name != null && length(v.service_operations_host_name) > 0 }
}
output "iothub_dpses_sku" {
  description = "Map of sku values across all iothub_dpses, keyed the same as var.iothub_dpses"
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.sku if v.sku != null && length(v.sku) > 0 }
}
output "iothub_dpses_tags" {
  description = "Map of tags values across all iothub_dpses, keyed the same as var.iothub_dpses"
  value       = { for k, v in azurerm_iothub_dps.iothub_dpses : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
